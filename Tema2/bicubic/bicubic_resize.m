function R = bicubic_resize(I, p, q)
  ...
  mTransformare=zeros(2,2);
  mTransformare(1,1)=s_x;
  mTransformare(2,2)=s_y;
    % TODO: Calculeaza inversa transformarii.
  inversa=inv(mTransformare);
  ...
  [Ix,Iy,Ixy]=precalc_d(I);
    ...
    for y = 0 : p - 1
        for x = 0 : q - 1
          ...
          vect1=[1 c(2) c(2)*c(2) c(2)*c(2)*c(2)];
          vect2=[1; c(1); c(1)*c(1); c(1)*c(1)*c(1)];
          R(y+1,x+1)=vect1*A'*vect2;
        endfor
    endfor
